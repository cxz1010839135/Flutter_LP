...
Blockly.CSharp['lists_repeat'] = function(block) {
  ...
  var argument1 = Blockly.CSharp.valueToCode(block, 'NUM',
      Blockly.CSharp.ORDER_NONE) || '0';//Blockly.CSharp.ORDER_COMMA
...
Blockly.CSharp['lists_length'] = function(block) {
  // List length.
  var argument0 = Blockly.CSharp.valueToCode(block, 'VALUE', Blockly.CSharp.ORDER_UNARY_POSTFIX) || 'null';//Blockly.CSharp.ORDER_FUNCTION_CALL
  return [argument0 + '.Count', Blockly.CSharp.ORDER_UNARY_POSTFIX];//Blockly.CSharp.ORDER_MEMBER
};

Blockly.CSharp['lists_isEmpty'] = function(block) {
  // Is the list empty?
  var argument0 = Blockly.CSharp.valueToCode(block, 'VALUE',
      Blockly.CSharp.ORDER_UNARY_POSTFIX) || 'null';//Blockly.CSharp.ORDER_MEMBER
  return [argument0 + '.Count == 0', Blockly.CSharp.ORDER_UNARY_PREFIX];//Blockly.CSharp.ORDER_LOGICAL_NOT
};
...
Blockly.CSharp['lists_getIndex'] = function(block) {
  ...
  var at = Blockly.CSharp.valueToCode(block, 'AT',
      Blockly.CSharp.ORDER_UNARY_PREFIX) || '1';//Blockly.CSharp.ORDER_UNARY_NEGATION
