...
Blockly.Msg.THREAD_TITLE = "PLC模拟线程";
Blockly.Msg.THREAD_DELAY_TITLE = "延时%1毫秒";
Blockly.Msg.THREAD_ALARM_TITLE = "置位PLC报警";
Blockly.Msg.THREAD_SET_TIMER_TITLE = "计时器 %1 计时 %2 毫秒";
Blockly.Msg.THREAD_RST_TIMER_TITLE = "停止计时器";
Blockly.Msg.THREAD_GET_COIL_TITLE = "M";//获取
Blockly.Msg.THREAD_GET_D_TITLE = "获取D";
Blockly.Msg.MOTION_MOVEPTP_AVOID="门型连续避障 到";
Blockly.Msg.MOTION_MOVEL_AVOID_LIST="避障列表";
Blockly.Msg.MOTION_TITLE_CREATEWITH = "避障点";
Blockly.Msg.MOTION_CREATE_ITEM_TOOLTIP = "将一个点添加到列表中。";
Blockly.Msg.MOTION_CREATE_TITLE_JOIN = "加入";
Blockly.Msg.MOTION_CREATE_TOOLTIP = "添加、移除或重新排列各节来重新配置这个列表。";
Blockly.Msg.MOTION_CREATE_ITEM_TITLE_ITEM_COND = "条件";
Blockly.Msg.MOTION_CREATE_ITEM_TITLE_ITEM = "P";
Blockly.Msg.MOTION_CREATE_ITEM_TITLE_ITEM_ERR = "允许误差e";
Blockly.Msg.MOTION_TEXT_HELPURL = "https://zh.wikipedia.org/wiki/String_";
Blockly.Msg.MOTION_TEXT_TOOLTIP = "一个字母、单词或一行文本。";

////
Blockly.Msg.MOTION_EXEPLACE="执行对贴";
Blockly.Msg.MOTION_EXEPLACE_COORDINATE="执行阵列对贴";
Blockly.Msg.MOTION_MOVEPTP="门型定位 到";
Blockly.Msg.MOTION_MOVEPTPL="线性门型定位 到";
Blockly.Msg.MOTION_MOVEZTP="回位定位 到";
Blockly.Msg.MOTION_MOVERTP="圆弧插补 到";
Blockly.Msg.MOTION_MOVEDG="动态抓取 到";
Blockly.Msg.MOTION_HEIGHTAVOID="避障高度";
Blockly.Msg.MOTION_RADIUS="半径";
Blockly.Msg.MOTION_DIR="经过点";
Blockly.Msg.MOTION_MAXSPEED="最大速度";
Blockly.Msg.MOTION_ENDSPEED="终点速度";
Blockly.Msg.MOTION_POS_ADJUST="纠偏补偿";
Blockly.Msg.MOTION_ADJUST_Y="是";
Blockly.Msg.MOTION_ADJUST_N="否";
Blockly.Msg.MOTION_MOVEL="直线定位 到";;
Blockly.Msg.MOTION_GET_CURRENT_AXISPOS="获取当前坐标轴位置";
Blockly.Msg.MOTION_GET_CURRENT_JOINTANGLE="获取当前关节轴角度";
Blockly.Msg.MOTION_POS_JOINTANGLE="关节轴角度";
Blockly.Msg.MOTION_POS_AXISPOS="坐标轴位置";
Blockly.Msg.MOTION_GET_POINT="获取坐标点";
Blockly.Msg.MOTION_SET_POINT="设置坐标点";
Blockly.Msg.MOTION_GET_IO_INPUT_STATUS="获取IO输入口状态";
Blockly.Msg.MOTION_GET_IO_OUTPUT_STATUS="获取IO输出口状态";
Blockly.Msg.MOTION_SET_IO_OUTPUT="设置IO输出口";
Blockly.Msg.MOTION_BUFFER_IO_OUTPUT="缓存IO输出口";
Blockly.Msg.MOTION_SET_OUTPUT="设置输出口";
Blockly.Msg.MOTION_RATIO_OUTPUT="位移比";
Blockly.Msg.MOTION_IO_OUTPUT_STATUS="状态";
Blockly.Msg.MOTION_SET_COMPORT="设置串口";
Blockly.Msg.MOTION_COMPORT="串口";
Blockly.Msg.MOTION_BAUDRATE="波特率";
Blockly.Msg.MOTION_DATABIT="数据位";
Blockly.Msg.MOTION_STOPBIT="停止位";
Blockly.Msg.MOTION_PARITYBIT="奇偶校验";
Blockly.Msg.MOTION_PARITYBIT_EVEN="偶";
Blockly.Msg.MOTION_PARITYBIT_ODD="奇";
Blockly.Msg.MOTION_PARITYBIT_NONE="无";
Blockly.Msg.MOTION_GET_REGISTERDATA="读取寄存器数据";
Blockly.Msg.MOTION_GET_COILSTATUS="读取线圈状态";
Blockly.Msg.MOTION_SET_REGISTERDATA="写入寄存器数据";
Blockly.Msg.MOTION_REGISTERVALUE="数据";
Blockly.Msg.MOTION_SET_COIL="设置线圈";
Blockly.Msg.MOTION_COILSTATUS="状态";
Blockly.Msg.MOTION_DELAY="延时";
Blockly.Msg.MOTION_MILLISECOND_UNIT="毫秒";
Blockly.Msg.MOTION_SECOND_UNIT="秒";
Blockly.Msg.MOTION_SAVETO="存放到";

Blockly.Msg.MOTION_MOVE_OFFSET_X="X方向偏移";
Blockly.Msg.MOTION_MOVE_OFFSET_Y="Y方向偏移";
Blockly.Msg.MOTION_MOVE_OFFSET_Z="Z方向偏移";
Blockly.Msg.MOTION_MOVE_OFFSET_W="旋转姿态偏移";

Blockly.Msg.MOTION_CENTER_OFFSET_X="圆心X偏移";
Blockly.Msg.MOTION_CENTER_OFFSET_Y="圆心Y偏移";
Blockly.Msg.MOTION_CENTER_OFFSET_C="圆弧角度";

Blockly.Msg.MOTION_MOVEPTP_DIR="门型定位 方向";
Blockly.Msg.MOTION_MOVEPTP_DIR_START="起始点";
Blockly.Msg.MOTION_MOVEPTP_DIR_DIR="方向点";
Blockly.Msg.MOTION_MOVEPTP_DIR_OFFSET="偏移";

Blockly.Msg.MOTION_MOVE_COORDINATE="摆盘";
Blockly.Msg.MOTION_MOVE_COORDINATE_START="起始点P";
Blockly.Msg.MOTION_MOVE_COORDINATE_XDIR="行方向点P";
Blockly.Msg.MOTION_MOVE_COORDINATE_YDIR="列方向点P";
Blockly.Msg.MOTION_MOVE_COORDINATE_XSTEP="行间距";
Blockly.Msg.MOTION_MOVE_COORDINATE_YSTEP="列间距";
Blockly.Msg.MOTION_MOVE_COORDINATE_XINDEX="行编号";
Blockly.Msg.MOTION_MOVE_COORDINATE_YINDEX="列编号";

// Blockly.Msg.MOTION_ELEMENT_TYPE_eI="EtherCATIn";
// Blockly.Msg.BKY_MOTION_ELEMENT_EtherCAT="EtherCATOut";
...
Blockly.Msg.MOTION_COILSTATUS_SET="置位";
Blockly.Msg.MOTION_COILSTATUS_RST="复位";

Blockly.Msg.MOTION_IO_OUTPUT_STATUS_SET="输出";
Blockly.Msg.MOTION_IO_OUTPUT_STATUS_RST="清除";


Blockly.Msg.MOTION_ERROR_SPEEDERROR = "请检查最大速度和最小速度设置是否正确,最大速度大于0,最小速度大于等于0";
Blockly.Msg.MOTION_ERROR_POINTINDEXERROR = "请检查坐标点编号是否正确,只能填写大于等于0整数";
Blockly.Msg.MOTION_ERROR_POINT_NOT_EXIST = "保存的点位库中不存在 P";
Blockly.Msg.CONTROL_ERROR_LOGICERROR = "此模块不能单独作为语句使用,请连接到其他语句中使用!";
Blockly.Msg.MATH_ERROR_NUMBERERROR = "此模块不能单独作为语句使用,请连接到其他语句中使用!";
Blockly.Msg.MOTION_ERROR_READERROR = "此模块不能单独作为语句使用,请连接到其他语句中使用!";
Blockly.Msg.CAMERA_ERROR_CAMERAINDEXERROR="请检查相机编号是否正确,只能填写大于等于0整数";
Blockly.Msg.CAMERA_ERROR_OBJECTINDEXERROR="请检查产品编号是否正确,只能填写大于等于0整数";
Blockly.Msg.CAMERA_ERROR_OBJECTNUMBERERROR="请检查产品个数是否正确,只能填写大于等于0整数";

Blockly.Msg.MOTION_STARTMOVE = "机械手开始运动";
Blockly.Msg.MOTION_WAITROBOT = "等待机械手动作完成";

///
Blockly.Msg.PROJECT_NAME = "项目名称";
////
Blockly.Msg.MATH_HUE = "100";//#c5c6ca
...
Blockly.Msg.CAMERA_GRAB="拍照";
Blockly.Msg.CAMERA_GRABIMAGE = "号相机拍照";
Blockly.Msg.CAMERA_GET="获取";
Blockly.Msg.CAMERA_POS_AXISPOS = "拍照位置结果";
Blockly.Msg.CAMERA_COORDINATE="阵列 ";

Blockly.Msg.CAMERA_CAMERAINDEX="号相机";
Blockly.Msg.CAMERA_OBJECTINDEX="号产品";
Blockly.Msg.CAMERA_OBJECTNUMBER="个产品";
Blockly.Msg.CAMERA_OFFSETINDEX="号补偿值";
Blockly.Msg.CAMERA_GRABRESULT="拍照结果";

Blockly.Msg.CAMERA_CALRESULT="计算结果";
Blockly.Msg.CAMERA_SAVE_TO_POINT="计算结果保存到点";

Blockly.Msg.CAMERA="相机";
Blockly.Msg.CAMERA_PLACE="贴合到";
Blockly.Msg.CAMERA_FIXED_POS="固定位置";
Blockly.Msg.CAMERA_IMAGE_POS="拍照位置";

Blockly.Msg.MOTION_PLC_TYPE="PLC型号";
Blockly.Msg.MOTION_PLC_TYPE_FX="FX系列";
Blockly.Msg.MOTION_PLC_TYPE_XJ="迅捷";
Blockly.Msg.MOTION_PLC_TYPE_DEFAULT="其它";

Blockly.Msg.EXECUTE_RESULT="执行结果";