...
Blockly.Css.CONTENT = [
  '.blocklySvg {',
    //'background-color: #c5c6ca;',//#fff  workspace背景颜色 #c5c6ca
    'outline: none;',
  ...
  */
  ...
  /* PLC-style: inline comment below block */
  '.blocklyCommentInlineLabel {',
    'pointer-events: none;',
  '}',
  '.blocklyCommentInlineLabel foreignObject {',
    'pointer-events: auto;',
  '}',
  '.blocklyCommentInlineTextarea {',
  ...
  '}',
  '.blocklyCommentInlineTextarea:focus {',
