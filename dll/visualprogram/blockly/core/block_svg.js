...
Blockly.BlockSvg.prototype.showContextMenu_ = function(e) {
  ...
  if (this.isDeletable() && this.isMovable() && !block.isInFlyout) {
    ...
    var copyOption = {
      //复制
      text: Blockly.Msg.CROSS_TAB_COPY,
      enabled: true,
      callback: function() {
        Blockly.copyd_(block);
        Blockly.copyBool_ =true;
      }
    };
    if (this.getDescendants().length > this.workspace.remainingCapacity()) {
    ...
    // Option to delete this block.//删除块
    // Count the number of blocks that are nested in this block.计算此块中嵌套的块的数量。
