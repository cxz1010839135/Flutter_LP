...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function(e) {
  ...
  // Options to undo/redo previous action.撤销
  var undoOption = {};
 ...
 // alert(-this.toolbox_.getWidth()+this.clientX+"    this.toolbox_.getWidth():"+this.toolbox_.getWidth()+"   this.clientX:"+this.clientX)
  // if(Blockly.copyXml_!= null){
  //    Blockly.copyXml_.setAttribute('x', this.clientX);
  //    Blockly.copyXml_.setAttribute('y', this.clientY);
  // }
  // var pasteOption = {
  //   //粘贴
  //   text: Blockly.Msg.CROSS_TAB_PASTE,
  //   enabled: Blockly.copyBool_,
  //   callback: function() {
  //     //粘贴到当前位置
  //     Blockly.copySpace_.paste(Blockly.copyXml_ );
  //   }
  // };
...
Blockly.WorkspaceSvg.prototype.scrollCenter_xy = function(x,y) {
  this.scrollbar.set(x, y);
};
