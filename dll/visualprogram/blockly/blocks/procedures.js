...
/**
 * 重新定义block颜色
 * BKY_BLOCK_PROCEDURES_RGB "%{BKY_BLOCK_PROCEDURES_RGB}"
 * Msg 中添加 BKY_BLOCK_PROCEDURES_RGB
 */
...
Blockly.Blocks['procedures_defnoreturn'] = {
  ...
  init: function() {
    ...
    this.setColour("#1f95ff");//("%{BKY_BLOCK_PROCEDURES_RGB}");//Blockly.Blocks.procedures.HUE
...
Blockly.Blocks['procedures_defreturn'] = {
  ...
  init: function() {
    ...
    this.setColour("%{BKY_BLOCK_PROCEDURES_RGB}");
