...
Blockly.Blocks['text_getSubstring'] = {
  ...
  init: function() {
    ...
    this.setColour(Blockly.CustomConfig.BLOCK_CONTROL_RGB);
...
Blockly.Blocks['text_changeCase'] = {
  ...
  init: function() {
    ...
    this.setColour(Blockly.CustomConfig.BLOCK_CONTROL_RGB);// Blockly.Blocks.texts.HUE
...
Blockly.Blocks['text_print'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "previousStatement": null,
      "nextStatement": null,
      "colour": "%{BKY_BLOCK_CONTROL_RGB}",//Blockly.Blocks.texts.HUE,
